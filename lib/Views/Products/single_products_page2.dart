...
class SingleProductPageTwo extends StatefulWidget {
  ...
  @override
  State<SingleProductPageTwo> createState() => _SingleBrandProductState();
}

class _SingleBrandProductState extends State<SingleProductPageTwo> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        return true; //return true will make page pop happen. return false will not
      },
      child: Scaffold(
        appBar: AppBar(
                          ...
                          child: PageView(
                            ...
                            children: [
                              for (int i = 0; i < 1; i++)
                                ...
                                //     ?
                                CachedNetworkImage(
                                  imageUrl: widget.data.defaultImage != null
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                widget.data.unit != null
                                    ? "  (per ${(widget.data.unit).toLowerCase()})"
                                    : " ",
                                style: TextStyle(
                                    height: .4,
                                    fontSize: 22,
                          ...
                          //       : " ",
                          //   style: TextStyle(
                          //       color: ConstantColors().greyPrimary, height: 1.4),
                          // ),
